...
/*! @file econio.c
 * \brief Az InfoC-rõl letöltött, Czirkos Tanár Úr által készített modul,
  ami megkönnyíti a konzol színezését és a billentyûlenyomások kezelését.

 https://github.com/czirkoszoltan/c-econio
 */
